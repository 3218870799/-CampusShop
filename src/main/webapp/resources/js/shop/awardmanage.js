$(function() {
	var shopId = 1;
	var listUrl = '/CampusShop/shopadmin/listawardsbyshop?pageIndex=1&pageSize=9999&shopId='
			+ shopId;
	var deleteUrl = '/CampusShop/shopadmin/modifyaward';
			...
			.on(
					...
					function(e) {
						...
						if (target.hasClass('edit')) {
							window.location.href = '/CampusShop/shopadmin/awardedit?awardId='
	...
	$('#new').click(function() {
		window.location.href = '/CampusShop/shopadmin/awardedit';
	});
});