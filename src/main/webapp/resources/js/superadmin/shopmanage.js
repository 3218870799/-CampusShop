...
function ajaxTable() {
	...
	enableStatusBuffer
			.append('<option id="shopManagementFilter_YES" value="1">待审核</option>');
	enableStatusBuffer
			.append('<option id="shopManagementFilter_APPLY" value="2">启用</option>');
	enableStatusBuffer
...
function shopManagementEdit() {
	...
	shopCategory.shopCategoryId = encodeURIComponent($(
